...
pdf_lib.lhapdf_vec_xfxQ.argtypes = [c_void_p, c_int, double_arr, c_double, double_arr, c_int]
pdf_lib.lhapdf_vec_xfxQ.restype = None
...
class LhaPdfWrapper:
    ...
    def xfxQ(self, pid, x, q):
        ...
        pdf_lib.lhapdf_vec_xfxQ(self.pdf, pid, x_flat, q, out, len(x_flat))
